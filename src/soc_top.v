...
module soc_top (
  ...
  // PCPI Interface (Aterrada para evitar erros de driver)
  wire        pcpi_valid;
  wire [31:0] pcpi_insn;
  wire [31:0] pcpi_rs1;
  wire [31:0] pcpi_rs2;
...
//    .mem_axi_rresp(mem_axi_rresp),
  ...
  wire        gpio_awvalid, gpio_awready, gpio_wvalid, gpio_wready, gpio_bvalid, gpio_bready, gpio_arvalid, gpio_arready, gpio_rvalid, gpio_rready;

  wire [11:0] uart_awaddr, uart_araddr;
  ...
  wire [11:0] spi_awaddr, spi_araddr;
  wire [31:0] spi_wdata, spi_rdata;
  wire [3:0]  spi_wstrb;
  ...
  wire [11:0] i2c_awaddr, i2c_araddr;
  wire [31:0] i2c_wdata, i2c_rdata;
  wire [3:0]  i2c_wstrb;
  ...
  axi_ram ram_inst (
    .clk(clk), .resetn(resetn),
    .boot_we(boot_we), .boot_addr(boot_addr), .boot_wdata(boot_wdata),
  ...
  // ... (GPIO, UART, SPI, I2C, Timer instâncias seguem o mesmo padrão) ...
  // Garantir que todas as portas s_axi_bresp e s_axi_rresp estejam conectadas aos fios corretos.
